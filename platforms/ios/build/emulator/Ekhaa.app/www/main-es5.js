...
var AppComponent = /** @class */ (function () {
    function AppComponent(keycloakService, translate, switchLangService, sessionService, platform) {
        var _this = this;
...
var CaseActivitiesComponent = /** @class */ (function () {
    function CaseActivitiesComponent(caseActivityService) {
...
var DashletTableComponent = /** @class */ (function () {
    function DashletTableComponent(translate, loader, switchLangService) {
        this.translate = translate;
        this.loader = loader;
        this.switchLangService = switchLangService;
        this.title = '';
    ...
    DashletTableComponent.prototype.ngAfterViewInit = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"])(this.sort.sortChange, this.paginator.page, this.casesFilter.filter)
            ...
            _this.isRateLimitReached = true;
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])({});
        })).subscribe(function (data) { return _this.data = data.items; });
    };
...
var FilterService = /** @class */ (function () {
    ...
    FilterService.prototype.getDepartments = function () {
        return this.departments;
    };
    FilterService.prototype.getRequestNames = function () {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(route, servicesService, trans) {
        this.route = route;
        this.servicesService = servicesService;
        this.trans = trans;
    }
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.loadProfile(_this.profileId);
        });
    };
...
var RequestDetailsComponent = /** @class */ (function () {
    function RequestDetailsComponent(route, switchLangService) {
        this.route = route;
        this.switchLangService = switchLangService;
...
var ServiceCatalogComponent = /** @class */ (function () {
    function ServiceCatalogComponent(servicesService, filterPipe, keycloakService, requestsService, trans) {
        this.servicesService = servicesService;
    ...
    ServiceCatalogComponent.prototype.mostUsed = function () {
        var _this = this;
        this.dataMostUsed = [];
        this.servicesService.getServices().subscribe(function (data) { return _this.dataMostUsed = data.entries; });
    };
    // prepare filter to be displayed
    ServiceCatalogComponent.prototype.prepareFilters = function (userSegments) {
        var _this = this;
        this.servicesService.getSegments().subscribe(function (data) {
        ...
        this.servicesService.getSegmentType().subscribe(function (data) {
            _this.segmentType = data.entries;
        });
...
var ServiceDetailsComponent = /** @class */ (function () {
    function ServiceDetailsComponent(route, servicesService, trans) {
        this.route = route;
        this.servicesService = servicesService;
        this.trans = trans;
        this.stats = 10;
    ...
    ServiceDetailsComponent.prototype.getStats = function (id) {

...
const keycloakConfig: KeycloakConfig = {
  ...
  url: 'http://3.88.151.225:9080/auth',
  realm: 'jhipster',
  clientId: 'web_app'
...
export const environment = {
  ...
  cms: {
    api: {
      master: 'http://3.88.151.225:8089',
      assets: 'http://3.88.151.225:8089/storage/uploads'
  ...
  beneficiaryApi: {
    api: 'http://3.88.151.225:8084/api/portal/beneficiaries',
  },

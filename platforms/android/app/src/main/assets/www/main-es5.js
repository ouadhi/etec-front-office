...
module.exports = "<app-page>\n\n  <div class=\"sideButtonContainer\" *appHasRole=\"['department_specialist','branch_specialist']\">\n    <a mat-button mat-raised-button color=\"primary\"\n      routerLink=\"/opportunity/add\">{{'NAV.ADD_OPPORTUNITY' | translate}}</a>\n  </div>\n\n  <app-dashlet-table-opp\n    [ngClass]=\"{'alignSwitchAR': switchLangService.currentLang=='ar', 'alignSwitchEN':switchLangService.currentLang=='en'}\"\n    [columns]=\"dashletCols\" title=\"{{ 'OPPORTUNITY.ALL_PAGETITLE' | translate}}\" [service]=\"dashletService\"\n    [detailsRouterForEachItem]=\"'/opportunity/view'\"></app-dashlet-table-opp>\n\n\n\n</app-page>"
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (userInfo.authorities.indexOf(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].roles.branch_specialist) > -1) {
                            this.submission = {
                                data: {
                                    enableBranch: false
                                }
...
module.exports = ".applicantsSection__send {\n  float: left;\n  margin-bottom: 10px; }\n\n.applicantsSection__table {\n  width: 100%;\n  margin: 10px 0 20px 0; }\n\napp-page ::ng-deep .formio-disabled-input button:disabled {\n  display: none; }\n\n.alignSwitchAR {\n  text-align: right; }\n\n.alignSwitchEN {\n  text-align: left; }\n\nion-toolbar {\n  --background: transparent;\n  z-index: 0;\n  font-family: inherit; }\n\nion-toolbar * {\n    font-family: inherit; }\n\n.content {\n  position: relative;\n  min-height: calc(100% - 49px);\n  height: auto;\n  overflow: hidden;\n  width: 100%;\n  padding: 10px; }\n\n:host {\n  display: block;\n  padding: 5px; }\n\n:host::ng-deep .mat-paginator-page-size {\n  display: none; }\n\n.width-100 {\n  width: 100%; }\n\n.footer {\n  text-align: center; }\n\nmat-header-row {\n  background: var(--ion-color-lesslight);\n  border-radius: 3px;\n  background: #f7f7f7; }\n\nmat-table {\n  font-family: inherit;\n  background: transparent; }\n\nmat-row {\n  border: 0px;\n  min-height: 58px;\n  background: #fcfcfc;\n  border-radius: 0;\n  margin: 5px auto;\n  box-shadow: 0 0 !important; }\n\nmat-row:hover {\n    opacity: 0.8; }\n\nmat-row.expanded {\n    border-radius: 5px 5px 0px 0px;\n    z-index: 9; }\n\nmat-paginator {\n  font-family: inherit;\n  background: transparent; }\n\n.element-detail {\n  overflow: hidden;\n  display: -webkit-box;\n  display: flex;\n  padding: 5px 20px; }\n\n.detail-row {\n  margin-top: -10px;\n  min-height: 0;\n  border-radius: 0px 0px 5px 5px;\n  z-index: 1; }\n\n.filter-container {\n  margin: 5px 10px;\n  padding-top: 50px;\n  position: absolute;\n  top: 60px;\n  left: 0px;\n  width: calc(100% - 20px);\n  height: calc(100% - 56px); }\n\n.mat-header-cell,\n.mat-cell {\n  -webkit-box-pack: center;\n          justify-content: center; }\n\n@media screen and (max-width: 960px) {\n  mat-row {\n    padding: 5px 10px; }\n  .mat-table {\n    border: 0;\n    vertical-align: middle; }\n  mat-header-row {\n    display: none; }\n  .mat-table caption {\n    font-size: 1em; }\n  .mat-table .mat-header-cell:last-child {\n    border: 10px solid;\n    clip: rect(0 0 0 0);\n    height: 1px;\n    margin: -1px;\n    padding: 0;\n    position: absolute;\n    width: 1px; }\n  .mat-table .mat-row {\n    display: block;\n    min-height: auto; }\n  /*\n    .mat-table .mat-row:nth-child(even) {background: #CCC}\n    .mat-table .mat-row:nth-child(odd) {background: #FFF}\n    */\n  .mat-table .mat-header-cell {\n    padding-left: 10px; }\n  .mat-table .mat-cell {\n    font-size: 13px !important;\n    border-bottom: 1px solid #ddd;\n    display: block;\n    font-size: 15px;\n    text-align: left;\n    min-height: auto;\n    height: 24px;\n    margin-bottom: 0%;\n    padding: 12px 0px 7px 0px;\n    box-sizing: content-box; }\n    .mat-table .mat-cell:first-child {\n      padding-left: 0px; }\n    .mat-table .mat-cell:last-child {\n      padding-right: 0px; }\n    .mat-table .mat-cell ion-chip {\n      margin-top: -7px; }\n  .mat-table .mat-cell:before {\n    /*\n      * aria-label has no advantage, it won't be read inside a table\n      content: attr(aria-label);\n      */\n    content: attr(data-label);\n    float: right;\n    text-transform: uppercase;\n    font-weight: normal;\n    font-size: 0.85em; }\n  .mat-table .mat-cell:last-child {\n    border-bottom: 0; }\n  .mat-table .mat-cell:first-child {\n    margin-top: 4%; }\n  .alignSwitchAR {\n    text-align: right; }\n  .alignSwitchEN {\n    text-align: left; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
